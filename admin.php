<?php
  ...
  $filename=date("G-i-s");
  if (move_uploaded_file($_FILES['test']['tmp_name'], "./tests/$filename.json")) header('Location: http://university.netology.ru/user_data/azaplutakhin/php-http/list.php');
 }
 ...
 foreach ($tests as $test){
     if ($test !=='..' and $test!=='.' and $test!=='test.php'){
        ...
        echo "<p><a href='php/tests/test.php?test=$test'> $name </a></p>";
 }
 }
?>
